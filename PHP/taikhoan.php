...
<body>
    <div class="header">
        ...
        <div class="header_content">
            <h1 class="header_main"> THÔNG TIN TÀI KHOẢN</h1>
            <p class="content_para">Dưới đây là danh sách các mặt hàng</p>
            <table class="content_table" >
                <tr>
                    <th class="tb_th">Loại tài khoản</th>
                    <th class="tb_th">Chức năng</th>
                </tr>

                <tr>
                    <td class="tb_td">Admin</td>
                    <td class="tb_td"><button class="tb_btn"><a class="btn_a" href="admin.php">Chi tiết</a></button></td>
                    <!-- <td class="tb_td">Điện thoại</td> -->
                </tr>
                <tr>
                    <td class="tb_td">User</td>
                    <td class="tb_td"><button class="tb_btn"><a class="btn_a" href="user.php">Chi tiết</a></button></td>
                    <!-- <td class="tb_td">Điện thoại</td> -->
                </tr>
