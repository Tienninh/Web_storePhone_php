...
<body>
    <div class="header">
        ...
        <div class="header_content">
            ...
            <?php
    include "connect.php";
    $result_dt = mysqli_query($conn, "SELECT * FROM dienthoai");
?>
    ...
    <tbody>
       <?php  while($value_dt = mysqli_fetch_assoc($result_dt)) {?>
        <tr>
            <td class="phanchinh"><?php echo $value_dt['id']?></td>
            <td class="phanchinh"><img width="50px" class="img_apple" src="/BTL_DienThoai/Image/list_img/<?php echo $value_dt['img']?>"></td>
            <td class="phanchinh"><p width="100px"><?php echo $value_dt['name']?></p></td>
            <td class="phanchinh"><?php echo $value_dt['gia']?>₫</td>
            <td class="phanchinh"><?php echo $value_dt['giagoc']?>₫</td>
            <td class="phanchinh"><?php echo $value_dt['baohanh']?></td>
            <td class="phanchinh"><?php echo $value_dt['thongtin']?></td>
            <td class="phanchinh"><a class="btn_chucnang them" href="them_sp.php">Thêm</a></td>
            <td class="phanchinh"><a class="btn_chucnang sua" href="sua_sp.php?this_id=<?php echo $value_dt['id']?>" class="btn btn-primary">Sửa</a></td>
            <td class="phanchinh"><a class="btn_chucnang xoa" href="xoa_sp.php? this_id_xoa=<?php echo $value_dt['id'] ?>">Xóa</a></td>
            </tr>
   <?php }?>
