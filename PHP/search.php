...
include "header.php";
    ...
    if( isset($_POST['btn_input_search'])){
        ...
        $sql = "SELECT * FROM dienthoai WHERE name LIKE '%$ten_dt%' ";                              
     $result = mysqli_query($conn, $sql);  

     $sql_mt = "SELECT * FROM maytinh WHERE name LIKE '%$tenmt%' ";                              
     $result_mt = mysqli_query($conn, $sql_mt);  

     $sql_tn = "SELECT * FROM tainghe WHERE name LIKE '%$tentn%' ";                              
     $result_tn = mysqli_query($conn, $sql_tn); 

     $sql_tl = "SELECT * FROM tablet WHERE name LIKE '%$tentl%' ";                              
