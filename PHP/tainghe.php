...
<body>
    <div class="header">
        ...
        <div class="header_content">
            ...
            <?php
    include "connect.php";
    $result_dt = mysqli_query($conn, "SELECT * FROM tainghe");
?>
    ...
    <tbody>
       <?php  while($value_mt = mysqli_fetch_assoc($result_dt)) {?>
        <tr>
            ...
            <td class="phanchinh"><img width="50px" class="img_apple" src="/BTL_DienThoai/Image/Tainghe_img/<?php echo $value_mt['img']?>"></td>
